...
\begin{subequations}
    \begin{align}
        \left.\frac{\partial \ln V}{\partial \ln T} \right|_p &= 1 + \left.\frac{\partial \ln \mathcal{N}}{\partial \ln T}\right|_p
        \\ \left.\frac{\partial \ln V}{\partial \ln p} \right|_T &= \left.\frac{\partial \ln \mathcal{N}}{\partial \ln p}\right|_T - 1
    \end{align}    
\end{subequations}
...
\miniheading{Notes on derivatives and Bridgmann tables}
...
This identity can be used alongside the \textit{Bridgman tables}, which will be used excessively in the next few sections. A copy of the Bridgman tables is contained in the \verb|documents| directory of this repository. We can start with an example, and then future derivatives will follow the same procedure, but will not be detailed.
\vspace{5mm}
...
\miniheading{Temperature derivatives and $c_p$}
...
Solving this system of equations is again, a non-iterative procedure, and we can use many of the previous systems entries to fill it. This makes the most expensive part just the LU solve. We can than find $c_v$ as:
...
And then other thermodynamic derivatives as:

\begin{equation}
    \left. \frac{\partial p}{\partial \rho} \right|_e = \frac{\frac{p}{\rho} \left[ \frac{\partial \ln V}{\partial \ln T} \right]_p - \frac{c_p}{\hat{R}}}{\left[ \frac{\partial \ln V}{\partial \ln T} \right]_p^2 + \frac{c_p}{ \hat{R} }\left[\frac{\partial \ln V}{\partial \ln p}\right]_T}
\end{equation}

\begin{equation}
    \left.\frac{\partial T}{\partial \rho} \right|_e = \frac{-\frac{T}{\rho} \left[ \left. \frac{\partial \ln V}{\partial \ln T} \right|_p + \left. \frac{\partial \ln V}{\partial \ln p} \right|_T \right]}{\left[ \frac{\partial \ln V}{\partial \ln T} \right]_p^2 + \frac{c_p}{ \hat{R} }\left[\frac{\partial \ln V}{\partial \ln p}\right]_T}
\end{equation}
...
\newpage
An example of this shown in \verb|helm::form_charge()|:
